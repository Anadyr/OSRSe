...
public class Magic {
     ...
     * We do this to make sure the player doesnt teleport with the wrong delay2 and gfx
     */
    ...
    private final boolean teleport(Teleports port, boolean force) {
        if(port.works) {
            owner.basicSettings().setAnimatedTP(true);
     ...
     */
    public enum Type {
        Standard(192), Ancient(193), Lunar(430), Tab, Enchantment, Home;
