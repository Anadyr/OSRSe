...
public class Pool<T extends Poolable> {
    ...
    /**
     * Initiates a newcache object pool.
     *
    ...
    /**
     * Retrieves a newcache object that isn't being used.
     * <p/>
     * If the pool is currently empty, it will create a newcache object and add it to
     * the pool.
     *
