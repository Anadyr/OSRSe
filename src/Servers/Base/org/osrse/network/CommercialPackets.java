...
public class CommercialPackets {
    ...
    public enum MasterResponse implements Identifyable {
        LOGIN_RESPONSE(0), ANNOUCE_WORLD(1), SYNC_WORLD(2), ACCEPT_PLAYER_REGISTRATION(3), ANNOUNCE_PLAYER(4), EDIT_PRIVACY(5), ANNOUNCE_LIST_EDIT(6), SEND_PM(7), FRIEND_SERVER(8), COM_RESP(9), CC_DEFINE(10), CC_EDIT(11), CC_RESP(12);
