...
public class Configuration {
    ...
    public Object[] getArray(String key) {
        ...
        if (obj instanceof Object[])
            return (Object[]) obj;
        throw new RuntimeException("Requested variable, " + key + ", is not an array or isn't available!");
    }
    ...
    public int[] getIntArray(String key, int defaultValue) {
        ...
        if (obj instanceof Object[]) {
            ...
            for (int i = 0; i < array.length; i++) {
                if (array[i] != null) {
                    intArray[i] = Integer.parseInt(array[i].toString().replaceAll(" ", ""));
                } else {
            ...
            return (int[]) obj;
        throw new RuntimeException("Requested variable, " + key + ", is not an integer array or isn't available!");
    }
    ...
    public String getString(String key) {
        ...
        if (obj instanceof String || obj instanceof Integer)
            return obj.toString();
        throw new RuntimeException("Request variable, " + key + ", is not a string type or isn't available!");
    }
