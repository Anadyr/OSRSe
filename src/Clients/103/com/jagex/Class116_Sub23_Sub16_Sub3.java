...
public final class Class116_Sub23_Sub16_Sub3 extends Animable {
   ...
   public static byte[] getDataFrom(Object var0, boolean var1, byte var2) {
      if(null == var0) {
         return null;
      } else if(var0 instanceof byte[]) {
         byte[] var4 = (byte[])((byte[])var0);
         return var1?Class55.copyArray(var4, -1836351588):var4;
      } else if(var0 instanceof Class63) {
         Class63 var3 = (Class63)var0;
         return var3.copyOf(1130068802);
      } else {
   ...
   protected final SpotAnim getRotatedModel(byte var1) {
      return RelationList.method778(this.anInt2646 * -848428919, (byte) 70).method2593(1308808435 * this.anInt2640, 173624722);
   }
}
