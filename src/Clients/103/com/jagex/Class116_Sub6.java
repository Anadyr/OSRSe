...
public class Class116_Sub6 extends Node {
   ...
   int anInt1734;
   RSInterface aClass116_Sub15_1736;
   Object[] anObjectArray1737;
   int anInt1738;
   boolean aBool1739;
   RSInterface aClass116_Sub15_1740;
   int anInt1741;
   int anInt1742;
   String aString1743;
   int anInt1744;
   static RSInterface aClass116_Sub15_1745;
   int anInt1747;


   static final void method1933(int var0, int var1, int var2, int var3, int var4, int var5, Region var6, Class58 var7, byte var8) {
      if(!client.aBool2937 || (Class47.aByteArrayArrayArray634[0][var1][var2] & 2) != 0 || (Class47.aByteArrayArrayArray634[var0][var1][var2] & 16) == 0) {
         ...
         if(var9.method2402(2031563592)) {
            ...
            Class116_Sub8.aClass117_1779.addLast(var16);
   ...
   public static final Class9 method1934(SignLink var0, Component var1, int var2, int var3, int var4) {
   ...
   public static void method1935(boolean var0, int var1) {
      if(Class93.aClass71_1335 != null) {
         try {
            ...
            Class93.aClass71_1335.flush(var2.payload, 0, 4, -508556464);
         } catch (IOException var5) {
            try {
               Class93.aClass71_1335.sync(-940778318);
