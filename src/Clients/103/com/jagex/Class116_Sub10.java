...
public class Class116_Sub10 extends Node {
   ...
   static Hashtable aHashtable_1803 = new Hashtable(32);
   ...
   public static final void method1971(boolean var0, byte var1) {
      RelationList.method777(-1074177723 * client.anInt3200, -452716157 * Class42.clientWidth, 674167779 * Class116_Sub16.clientHeight, var0, (short) -256);
   }

   public static void method1972(RSIndex var0, byte var1) {
      Class116_Sub23_Sub5.aRSIndex_2267 = var0;
   }

   static final void readPlayerHashLocations(PacketBuilder buffer, int var1) {
      buffer.resetBitPos((byte) 81);
      int var2 = 1467227105 * client.playerIndex;
      Player var3 = Class79.ourPlayer = client.globalPlayers[var2] = new Player();
      ...
      GameInterface.anInt1819 = (var3.anInt2906 = var8 * -1668953739) * -1941196453;
      if(null != Class7.aClass116_Sub14Array106[var2]) {
         var3.doAppearance(Class7.aClass116_Sub14Array106[var2], 2095903438);
      }
