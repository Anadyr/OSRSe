...
public class Class116_Sub23_Sub4 extends NodeContainer {
   ...
   static RSIndex aRSIndex_2243;
   static RSIndex aRSIndex_2244;
   ...
   static RSIndex aRSIndex_2264;

   void method2439(Packet var1, int var2) {
      while(true) {
   ...
   void method2440(Packet var1, int var2, int var3) {
      int var4;
      int var5;
      if(1 == var2) {
         var5 = var1.readUnsignedShort(1534595847);
         this.anIntArray2255 = new int[var5];

         for(var4 = 0; var4 < var5; ++var4) {
            this.anIntArray2255[var4] = var1.readUnsignedShort(381110350);
         }

         this.anIntArray2247 = new int[var5];

         for(var4 = 0; var4 < var5; ++var4) {
            this.anIntArray2247[var4] = var1.readUnsignedShort(1391590719);
         }

         for(var4 = 0; var4 < var5; ++var4) {
            this.anIntArray2247[var4] += var1.readUnsignedShort(1171785672) << 16;
         }
      } else if(2 == var2) {
         this.anInt2251 = var1.readUnsignedShort(1883372109) * 1049501723;
      } else if(3 == var2) {
         ...
         this.anInt2253 = var1.readUnsignedShort(1632841621) * -647941965;
      } else if(var2 == 7) {
         this.anInt2256 = var1.readUnsignedShort(-122781693) * -808696457;
      } else if(8 == var2) {
         ...
         for(var4 = 0; var4 < var5; ++var4) {
            this.anIntArray2259[var4] = var1.readUnsignedShort(1839025841);
         }

         for(var4 = 0; var4 < var5; ++var4) {
            this.anIntArray2259[var4] += var1.readUnsignedShort(767002877) << 16;
         }
      } else if(var2 == 13) {
         var5 = var1.readSignedByte(1708176767);
   ...
   public static Class116_Sub23_Sub19_Sub3 method2447(RSIndex var0, String var1, String var2, int var3) {
      int var4 = var0.getFileIdForName(var1, -779655899);
   ...
   static void method2469(RSInterface var0, int var1, int var2, int var3) {
      if(0 == var0.anInt1930 * -1186475957) {
         var0.x = 1700268279 * var0.xOffset;
      } else if(var0.anInt1930 * -1186475957 == 1) {
         var0.x = ((var1 - var0.wdth * 1645211541) / 2 + var0.xOffset * -459849887) * -79896745;
      } else if(2 == var0.anInt1930 * -1186475957) {
         var0.x = -79896745 * (var1 - var0.wdth * 1645211541 - -459849887 * var0.xOffset);
      } else if(-1186475957 * var0.anInt1930 == 3) {
         var0.x = -79896745 * (var0.xOffset * -459849887 * var1 >> 14);
      } else if(-1186475957 * var0.anInt1930 == 4) {
         var0.x = ((var1 - 1645211541 * var0.wdth) / 2 + (var1 * var0.xOffset * -459849887 >> 14)) * -79896745;
      } else {
         var0.x = -79896745 * (var1 - 1645211541 * var0.wdth - (var1 * -459849887 * var0.xOffset >> 14));
      }

      if(0 == -306698303 * var0.anInt1915) {
         var0.y = var0.yOffset * 1595301305;
      } else if(1 == var0.anInt1915 * -306698303) {
         var0.y = 1094821665 * (var0.yOffset * 538516377 + (var2 - 1227800423 * var0.heght) / 2);
      } else if(2 == -306698303 * var0.anInt1915) {
         var0.y = (var2 - 1227800423 * var0.heght - 538516377 * var0.yOffset) * 1094821665;
      } else if(3 == var0.anInt1915 * -306698303) {
         var0.y = (var2 * 538516377 * var0.yOffset >> 14) * 1094821665;
      } else if(4 == -306698303 * var0.anInt1915) {
         var0.y = 1094821665 * ((var2 - 1227800423 * var0.heght) / 2 + (var0.yOffset * 538516377 * var2 >> 14));
      } else {
         var0.y = 1094821665 * (var2 - 1227800423 * var0.heght - (var2 * 538516377 * var0.yOffset >> 14));
      }

      if(client.aBool2957 && var0.type * -1305917269 == 0) {
         if(332168295 * var0.x < 0) {
            var0.x = 0;
         } else if(1645211541 * var0.wdth + 332168295 * var0.x > var1) {
            var0.x = -79896745 * (var1 - 1645211541 * var0.wdth);
         }

         if(var0.y * 1492425953 < 0) {
            var0.y = 0;
         } else if(1492425953 * var0.y + 1227800423 * var0.heght > var2) {
            var0.y = (var2 - var0.heght * 1227800423) * 1094821665;
         }
      }

   }

   public static int charToIntCipher(CharSequence var0, int var1) {
      int var2 = var0.length();
      int var4 = 0;

      for(int var3 = 0; var3 < var2; ++var3) {
         var4 = (var4 << 5) - var4 + Ignore.cipherChar(var0.charAt(var3), -543467890);
      }
      ...
      if(null != var0) {
         ...
         if(null != var4) {
            for(int var2 = 0; var2 < -1616775607 * client.anInt3152; ++var2) {
               RelationList var3 = client.aClass50Array3204[var2];
   ...
   static Class116_Sub23_Sub17 method2473(int var0, byte var1) {
      ...
      if(null != var2) {
         ...
         RSIndex var3 = aRSIndex_2243;
         RSIndex var4 = aRSIndex_2244;
         boolean var5 = true;
