...
public class Class59_Sub1 extends Class59 {
   ...
   protected boolean method891(int var1, int var2, int var3, Class58 var4, int var5) {
      return 2014068737 * this.anInt777 == var2 && this.anInt774 * -1876894601 == var3;
   }
   ...
   static String method1978(int var0, byte var1) {
